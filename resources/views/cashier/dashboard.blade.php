<x-layouts.app>
    <x-page-header title="Dasbor" subtitle="Ringkasan hari ini — {{ now()->format('d M Y') }}" />
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div class="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs text-sky-600 bg-sky-50 px-2 py-0.5 rounded-full font-medium">Hari Ini</span>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full font-medium">Hari Ini</span>
            </div>
            <p class="text-3xl font-bold text-emerald-600">Rp {{ number_format($todayTotal, 2) }}</p>
