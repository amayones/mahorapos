<x-layouts.app>
    <x-page-header title="Users" subtitle="Manage your shop team" action-label="Add User" />

    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
            <h2 class="text-sm font-semibold text-slate-700">All Members</h2>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            @if($user->role === 'owner')
                                <span class="inline-flex px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-100 text-indigo-700">Owner</span>
                            @elseif($user->role === 'cashier')
                                <span class="inline-flex px-2.5 py-0.5 rounded-full text-xs font-semibold bg-sky-100 text-sky-700">Cashier</span>
                            @elseif($user->role === 'staff')
                                <span class="inline-flex px-2.5 py-0.5 rounded-full text-xs font-semibold bg-violet-100 text-violet-700">Staff</span>
                            @else
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <button class="text-xs text-slate-400 hover:text-red-500 transition-colors font-medium">Remove</button>
                            </div>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="5" class="px-6 py-16 text-center">
                            <p class="text-slate-400 text-sm">No team members yet.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
