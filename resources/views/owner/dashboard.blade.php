<x-layouts.app>
    <div class="mb-8">
        ...
        <p class="text-sm text-slate-500 mt-0.5">Welcome back, <span class="font-medium text-slate-700">{{ auth()->user()->name }}</span></p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-medium text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full">Products</span>
            </div>
            <p class="text-2xl font-bold text-slate-900">{{ $stats['products'] }}</p>
            <p class="text-xs text-slate-400 mt-1">Total products</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-medium text-violet-600 bg-violet-50 px-2 py-0.5 rounded-full">Team</span>
            </div>
            <p class="text-2xl font-bold text-slate-900">{{ $stats['users'] }}</p>
            <p class="text-xs text-slate-400 mt-1">Team members</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-medium text-sky-600 bg-sky-50 px-2 py-0.5 rounded-full">Sales</span>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
            ...
            <p class="text-2xl font-bold text-slate-900">RM {{ number_format($stats['revenue'], 2) }}</p>
