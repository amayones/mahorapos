...
<head>
    ...
    <title>Register — MahoraPOS</title>
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col justify-between p-12 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h2 class="text-3xl font-bold text-white mb-4 leading-snug">
                    Start your free trial<br>in 30 seconds
                </h2>
                <p class="text-slate-400 text-sm leading-relaxed mb-8">
                    Create your shop account and get instant access to the full POS system. No credit card required.
                </p>
                <div class="space-y-3">
                    @foreach(['Free 30-day trial', 'No credit card required', 'Cancel anytime'] as $feat)
        ...
        <div class="flex-1 flex items-center justify-center px-6 py-12">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-slate-500 text-sm mt-1">Set up your shop and start selling today</p>
                </div>
                ...
                <form method="POST" action="/register" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1.5">Shop Name</label>
